...
from identity_encoder.inference import plot_embedding_as_heatmap
from lab_console.utterance import Utterance
...
default_text = \
    "Welcome to the lab_console! To begin, load an utterance from your datasets or record one " \
...
class UI(QDialog):
    ...
    def play(self, wav, sample_rate):
        try:
            ...
            self.log("Your device must be connected before you start the lab_console.")
        ...
        if level <= 0:
            ...
            if datasets_root is None or len(datasets) == 0:
                ...
                msg += ".\nThe recognized datasets are:\n\t%s\nFeel free to add your own. You " \
                       "can still use the lab_console by recording samples yourself." % \
    ...
    def __init__(self):
        ...
        super().__init__(None)
        self.setWindowTitle("SV2TTS lab_console")
        ...
        #Replay & Save Audio
        browser_layout.addWidget(QLabel("<b>Lab Console Output:</b>"), i, 0)
